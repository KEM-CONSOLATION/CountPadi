...
export default function ProfitLossStatsCards() {
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[1, 2, 3, 4].map(i => (
          <div
            key={i}
            className="bg-white shadow-sm rounded-lg border border-gray-200 p-6 animate-pulse"
          >
  ...
  const sectionTitle = isToday ? "Today's Profit & Loss" : `Profit & Loss - ${getDateRangeLabel()}`

  return (
    <div>
      <div className="grid gap-2 md:flex items-center justify-between mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <svg
                className={`w-6 h-6 ${totalProfit >= 0 ? 'text-green-600' : 'text-orange-600'}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <svg
                className={`w-6 h-6 ${netProfit >= 0 ? 'text-green-600' : 'text-orange-600'}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
